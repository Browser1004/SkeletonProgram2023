...
class Dastan:
    def __init__(self, R, C,
                 NoOfPieces):  # Method is constructor of the class, creates rows, columns, pieces, players, board.
        self._Board = []
        self._Players = []
    ...
    def __DisplayBoard(self):  # Displays current state of the game board.
        print("\n" + "   ", end="")
    ...
    def __DisplayState(self):  # Displays current state of the game, including game board, current player and move
        # option offer.
        self.__DisplayBoard()
    ...
    def __GetIndexOfSquare(self, SquareReference):  # Returns the index of a square on the board given a square
        # reference.
        Row = SquareReference // 10
        Col = SquareReference % 10
        return (Row - 1) * self._NoOfColumns + (Col - 1)

    def __CheckSquareInBounds(self, SquareReference):  # Method checks if the square is within the bounds of the game
        # board.
        Row = SquareReference // 10
        Col = SquareReference % 10
    ...
    def __CheckSquareIsValid(self, SquareReference, StartSquare):  # Checks if the square is valid to be used as a
        # starting or ending square.
